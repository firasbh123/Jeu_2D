...
void afficherEnigme(Enigme e ,SDL_Surface *screen)
{
    ...
    TTF_Font *font2 = TTF_OpenFont("ARLRDBD.ttf", 10);
    ...
    SDL_Surface *questionSurface = TTF_RenderText_Blended(font2, e.question, (SDL_Color){0, 0, 0});
    if (!questionSurface)
    {
    ...
    SDL_Surface *choice1Surface = TTF_RenderText_Blended(font, e.reponse , (SDL_Color){0, 0, 0});
    SDL_Surface *choice2Surface = TTF_RenderText_Blended(font,e.choix1 , (SDL_Color){0, 0, 0});
    SDL_Surface *choicecSurface = TTF_RenderText_Blended(font,e.choix2, (SDL_Color){0, 0, 0});
    SDL_Surface *selectionright = IMG_Load("fleche_left-removebg-preview.png");
    SDL_Surface *selectionleft = IMG_Load("fleche_right-removebg-preview.png");
    ...
    SDL_Rect questionRect = {70, 100, questionSurface->w, questionSurface->h};
    SDL_Rect choice1Rect = {200, 280, choice1Surface->w, choice1Surface->h};
    SDL_Rect choice2Rect = {200, 400, choice2Surface->w, choice2Surface->h};
    SDL_Rect choicecRect = {200, 500, choicecSurface->w, choicecSurface->h};
    if (e.solved == 0)
    {
        afficherbackgroound(e.backgro,screen);
    ...
    {
        SDL_BlitSurface(e.won.img, NULL, screen, &e.backgro.posinscreen);
        Mix_HaltMusic();                     

    }
    else if (e.solved == 2)
    {
        SDL_BlitSurface(e.lost.img, NULL, screen,&e.backgro.posinscreen);
        Mix_HaltMusic(); 
    }
    else if (e.solved == 3)
    {
        SDL_BlitSurface(e.timeout.img, NULL, screen,&e.backgro.posinscreen);
        Mix_HaltMusic(); 
    }
...
void afficher_newscore(int score, SDL_Surface *screen, imageenigme c) {
    ...
    TTF_Font *font = TTF_OpenFont("ARLRDBD.ttf", 28);
        if (font == NULL) {
...
{
    c->img = IMG_Load("Sans titre-3.png");
    if (c->img == NULL)
    {
